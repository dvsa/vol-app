SELECT CONCAT('DROP PROCEDURE IF EXISTS sp_NI_Extract_update_table_counts;', CHAR(10), 'DELIMITER $$', CHAR(10), 'CREATE PROCEDURE sp_NI_Extract_update_table_counts()', CHAR(10), 'BEGIN') AS '';
