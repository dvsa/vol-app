...
BEGIN
    ...
    BEGIN
        ...
        -- Restore safety settings on error
    ...
    SET autocommit = 0;          -- Stop writing to the log on every single row delete
    SET FOREIGN_KEY_CHECKS = 0;  -- Disable relational checking loops during the purge
    SET UNIQUE_CHECKS = 0;       -- Disable unique secondary index constraint checking loops
