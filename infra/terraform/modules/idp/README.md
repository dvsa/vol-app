...
| [aws_s3_bucket_notification.documents](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_notification) | resource |
...
| <a name="output_documents_bucket_name"></a> [documents\_bucket\_name](#output\_documents\_bucket\_name) | Name of the S3 bucket where documents are uploaded. Classification triggers on Object Created events from this bucket. When GuardDuty is added, this bucket becomes the upload target and a separate clean-documents bucket will feed Classification. |
<!-- END_TF_DOCS -->