  ...
  batch = {
    ...
    jobs = [
      ...
      },
      {
        ...
        commands = ["queue:transxchange-consumer", "--queue-duration", "600"],
        timeout  = 620,
        schedule = "cron(0/10 7-18 * * ? *)",
      },
      {
