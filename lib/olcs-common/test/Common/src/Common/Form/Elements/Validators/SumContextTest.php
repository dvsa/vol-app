 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
final class SumContextTest extends MockeryTestCase
{
    protected $sut;
    ...
    /**
     * @return \Iterator<(int | string), array<(array<(float | int | null)> | bool | int | null)>>
     *
    ...
    public static function providerIsValid(): \Iterator
    {
        ...
        yield 'Hours Per Week invalid example with all contexts are null' => [
            1,
            null,
            [
                'hoursMon' => null,
        ...
        yield 'Hours Per Week invalid example with a zero digit in any 1 context' => [
            1,
            null,
            [
                'hoursMon' => null,
        ...
        yield 'Hours Per Week invalid example with a zero digit in any other context' => [
            1,
            null,
            [
                'hoursMon' => null,
        ...
        yield 'Hours Per Week valid example with one float value, rest are null' => [
            1,
            null,
            [
                'hoursMon' => null,
        ...
        yield 'Hours Per Week valid example with two float values, rest are null' => [
            1,
            null,
            [
                'hoursMon' => null,
        ...
        yield 'Hours Per Week valid example with all float value, none are null' => [
            1,
            null,
            [
                'hoursMon' => 3.5,
