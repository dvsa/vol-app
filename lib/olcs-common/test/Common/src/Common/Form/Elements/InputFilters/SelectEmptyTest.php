 ...
 */
#[\PHPUnit\Framework\Attributes\CoversClass(\Common\Form\Elements\InputFilters\SelectEmpty::class)]
final class SelectEmptyTest extends \PHPUnit\Framework\TestCase
{
    public $filter;
    /**
     * test setup
