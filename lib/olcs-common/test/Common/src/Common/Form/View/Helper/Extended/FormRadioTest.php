...
final class FormRadioTest extends MockeryTestCase
{
    #[\PHPUnit\Framework\Attributes\DataProvider('renderOptionsProvider')]
    ...
    /**
     * @return \Iterator<(int | string), array<(array<(array<(array<string> | bool | string)> | string)> | string | null)>>
     *
     ...
     */
    public static function renderOptionsProvider(): \Iterator
    {
        yield 'nothing_to_render' => [
            'options' => [],
            'selectedOptions' => [],
            'attributes' => [],
