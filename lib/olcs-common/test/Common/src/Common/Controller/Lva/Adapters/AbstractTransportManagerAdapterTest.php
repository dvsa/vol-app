 ...
 */
final class AbstractTransportManagerAdapterTest extends MockeryTestCase
{
    ...
    {
        $this->assertFalse($this->sut->mustHaveAtLeastOneTm());
    }
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('dataProviderTestMapResultForTable')]
    ...
    /**
     * @return \Iterator<(int | string), array<array<array<(array<(int | string)> | int | string | null)>>>>
     *
     ...
     */
    public static function dataProviderTestMapResultForTable(): \Iterator
    {
        $expectedName = [
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('dataProviderTestSortResultForTable')]
    ...
    /**
     * @return \Iterator<(int | string), array<(array<array<(array<string> | string)>> | int)>>
     *
     ...
     */
    public static function dataProviderTestSortResultForTable(): \Iterator
    {
