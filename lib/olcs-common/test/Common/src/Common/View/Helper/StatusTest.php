 ...
 * @author Mat Evans <mat.evans@valtech.co.uk>
 */
final class StatusTest extends \Mockery\Adapter\Phpunit\MockeryTestCase
{
    public $sut;
    ...
    protected function setUp(): void
    {
        ...
        $mockView = \Mockery::mock(\Laminas\View\Renderer\PhpRenderer::class);
        $this->sut->setView($mockView);
    }

    #[\PHPUnit\Framework\Attributes\DataProvider('dataProviderStatus')]
     ...
     */
    public static function dataProviderStatus(): \Iterator
    {
        yield [
            [],
            ''
