 ...
 */
final class IssuedPermitLicencePermitReferenceTest extends MockeryTestCase
{
    protected $urlHelper;
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('dpFormatLinkToIssuedPermits')]
     ...
     */
    public static function dpFormatLinkToIssuedPermits(): \Iterator
    {
        yield [
            [
                'id' => 3,
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('dpFormatLinkToApplication')]
     ...
     */
    public static function dpFormatLinkToApplication(): \Iterator
    {
        yield [
            [
                'id' => 100010,
