 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
final class PublicationNumberTest extends MockeryTestCase
{
    ...
    /**
     * @return \Iterator<(int | string), array<(array<(array<(int | string)> | int | string)> | int | string)>>
     *
    ...
    public static function provider(): \Iterator
    {
        ...
        yield "document-webdav-generated" => [
            [
                'pubStatus' => [
                    'id' => 'pub_s_generated'
                ],
