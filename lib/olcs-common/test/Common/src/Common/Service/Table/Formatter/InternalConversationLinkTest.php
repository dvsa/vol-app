 ...
 */
final class InternalConversationLinkTest extends MockeryTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $mockRefDataStatus = m::mock(RefDataStatus::class);

        $this->sut = new InternalConversationLink($this->urlHelper, $mockRefDataStatus, $this->mockRouteMatch);
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('conversationProvider')]
    ...
    public function testInternalFormatSetsCreatedOnToDefaultTimezone(
        ...
        preg_match('/<p class="govuk-body govuk-!-margin-1">(.*?)<\/p>/', (string) $result, $matches);
     ...
     */
    public static function conversationProvider(): \Iterator
    {
        yield 'application_route' => [
            'application',
            [
                'id' => 123,
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('conversationTimezoneProvider')]
    public static function conversationTimezoneProvider(): \Iterator
    {
        yield 'UTC date (winter)' => [
            'application',
            [
                'id' => 101,
                'userContextStatus' => 'NEW_MESSAGE',
