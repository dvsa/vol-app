...
class Create extends AbstractCommandHandlerTestCase
{
    ...
    public function testExternalUserMessageDoesNotUpdateActionDateWhenLastMessageWasExternal()
    {
        $data = [
            'conversation'   => $conversationId = 1,
    ...
    public function testExternalUserMessageUpdatesActionDateWhenLastMessageWasInternal()
    {
        $data = [
            'conversation'   => $conversationId = 1,
    ...
    public function testInternalUserMessageAlwaysUpdatesActionDate()
    {
        $data = [
            'conversation'   => $conversationId = 1,
