 ...
 */
final class GeneratePermitDocumentTest extends AbstractCommandHandlerTestCase
{
    ...
    public static function dpHandleCommand(): \Iterator
    {
        ...
        yield 'IRHP Bilateral - Czech Republic' => [
            'irhpPermitTypeId' => IrhpPermitTypeEntity::IRHP_PERMIT_TYPE_ID_BILATERAL,
        ...
        yield 'IRHP Bilateral - Kazakhstan' => [
            'irhpPermitTypeId' => IrhpPermitTypeEntity::IRHP_PERMIT_TYPE_ID_BILATERAL,
        ...
        yield 'IRHP Bilateral - Liechtenstein' => [
            'irhpPermitTypeId' => IrhpPermitTypeEntity::IRHP_PERMIT_TYPE_ID_BILATERAL,
        ...
        yield 'IRHP Bilateral - Lithuania' => [
            'irhpPermitTypeId' => IrhpPermitTypeEntity::IRHP_PERMIT_TYPE_ID_BILATERAL,
        ...
        yield 'IRHP Bilateral - Luxembourg' => [
            'irhpPermitTypeId' => IrhpPermitTypeEntity::IRHP_PERMIT_TYPE_ID_BILATERAL,
        ...
        yield 'IRHP Bilateral - Morocco - Empty entry' => [
            'irhpPermitTypeId' => IrhpPermitTypeEntity::IRHP_PERMIT_TYPE_ID_BILATERAL,
        ...
        yield 'IRHP Bilateral - Morocco - Hors contingent' => [
            'irhpPermitTypeId' => IrhpPermitTypeEntity::IRHP_PERMIT_TYPE_ID_BILATERAL,
            'countryId' => CountryEntity::ID_MOROCCO,
        ...
        yield 'IRHP Bilateral - Morocco - Standard multiple' => [
            'irhpPermitTypeId' => IrhpPermitTypeEntity::IRHP_PERMIT_TYPE_ID_BILATERAL,
            'countryId' => CountryEntity::ID_MOROCCO,
        ...
        yield 'IRHP Bilateral - Morocco - Standard single' => [
            'irhpPermitTypeId' => IrhpPermitTypeEntity::IRHP_PERMIT_TYPE_ID_BILATERAL,
            'countryId' => CountryEntity::ID_MOROCCO,
        ...
        yield 'IRHP Bilateral - Netherlands' => [
            'irhpPermitTypeId' => IrhpPermitTypeEntity::IRHP_PERMIT_TYPE_ID_BILATERAL,
