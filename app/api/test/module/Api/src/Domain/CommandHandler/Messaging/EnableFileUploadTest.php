...
class EnableFileUploadTest extends AbstractCommandHandlerTestCase
{
    ...
    public function testHandleCommand(): void
    {
        ...
        $mockOrganisation->expects('setIsMessagingFileUploadEnabled')->with(true);
        ...
        $this->assertEquals(['File upload enabled'], $result->getMessages());
    }
}
