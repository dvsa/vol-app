 ...
 */
final class PermitTypeConfigTest extends MockeryTestCase
{
    public const string RESTRICTED_COUNTRIES_QUESTION_KEY = 'restricted.countries.question.key';

    public const array RESTRICTED_COUNTRY_IDS = ['ES', 'FR', 'DE'];
