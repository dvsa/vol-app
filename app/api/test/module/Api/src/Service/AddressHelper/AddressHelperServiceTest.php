...
final class AddressHelperServiceTest extends TestCase
{
    ...
    {
        $query = 'AB12 3CD';
        $expectedTrafficArea = $this->createStub(Entity\TrafficArea\TrafficArea::class);
        $expectedAdminAreaTrafficArea = new \Dvsa\Olcs\Api\Entity\TrafficArea\AdminAreaTrafficArea();
        $expectedAdminAreaTrafficArea->setTrafficArea($expectedTrafficArea);
    ...
    {
        $postcode = 'AB1 2CD';
        $expectedEnforcementArea = $this->createStub(Entity\EnforcementArea\EnforcementArea::class);
        $expectedPostcodeEnforcementArea = new \Dvsa\Olcs\Api\Entity\EnforcementArea\PostcodeEnforcementArea();
        $expectedPostcodeEnforcementArea->setEnforcementArea($expectedEnforcementArea);
