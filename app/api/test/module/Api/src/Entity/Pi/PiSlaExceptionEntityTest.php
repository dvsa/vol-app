...
class PiSlaExceptionEntityTest extends EntityTester
{
     ...
     */
    public function testPiGetter(): void
    {
        $pi = m::mock(PiEntity::class);
        $slaException = m::mock(SlaExceptionEntity::class);
     ...
     */
    public function testSlaExceptionGetter(): void
    {
        $pi = m::mock(PiEntity::class);
        $slaException = m::mock(SlaExceptionEntity::class);
     ...
     */
    public function testEntityWithRelationships(): void
    {
        $pi = m::mock(PiEntity::class);
        $slaException = m::mock(SlaExceptionEntity::class);
     ...
     */
    public function testBundleSerialization(): void
    {
        $pi = m::mock(PiEntity::class);
     ...
     */
    public function testConstructorRequiresParameters(): void
    {
