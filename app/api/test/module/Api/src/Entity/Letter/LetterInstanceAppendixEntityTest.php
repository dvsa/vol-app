...
use Dvsa\Olcs\Api\Entity\Letter\LetterInstanceAppendix as Entity;
use Dvsa\Olcs\Api\Entity\Letter\LetterAppendixVersion;
use Dvsa\OlcsTest\Api\Entity\Abstracts\EntityTester;

/**
 * LetterInstanceAppendix Entity Unit Tests
 *
 * Initially auto-generated but won't be overridden
 */
final class LetterInstanceAppendixEntityTest extends EntityTester
{
    /**
    ...
    {
        $version = new LetterAppendixVersion();
        $version->setDefaultContent($default);

        $entity = new Entity();
        $entity->setLetterAppendixVersion($version);
