 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
final class ApplicationBusinessDetailsReviewServiceTest extends MockeryTestCase
{
    protected $sut;
    ...
    {
        yield 'Sole Trader (Without trading names)' => [
            [
                'licence' => [
                    'companySubsidiaries' => [],
                    'tradingNames' => [],
        ...
        yield 'Sole Trader (With trading names)' => [
            [
                'licence' => [
                    'companySubsidiaries' => [],
                    'tradingNames' => [
        ...
        yield 'Partnership (Without trading names)' => [
            [
                'licence' => [
                    'companySubsidiaries' => [],
                    'tradingNames' => [],
        ...
        yield 'Partnership (With trading names)' => [
            [
                'licence' => [
                    'companySubsidiaries' => [],
                    'tradingNames' => [
        ...
        yield 'Registered Company (No trading names or subsidiaries)' => [
            [
                'licence' => [
                    'companySubsidiaries' => [],
                    'tradingNames' => [],
        ...
        yield 'Registered Company (With trading names and subsidiaries)' => [
            [
                'licence' => [
                    'companySubsidiaries' => [
                        [
        ...
        yield 'LLP (No trading names or subsidiaries)' => [
            [
                'licence' => [
                    'companySubsidiaries' => [],
                    'tradingNames' => [],
        ...
        yield 'LLP (With trading names and subsidiaries)' => [
            [
                'licence' => [
                    'companySubsidiaries' => [
                        [
