 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
final class VariationGoodsOcTotalAuthReviewServiceTest extends MockeryTestCase
{
    protected $sut;
    ...
    public static function dpGetConfigFromData(): \Iterator
    {
        ...
        yield 'without changes - eligible for LGV' => [
            'data' => [
        ...
        yield 'with changes - eligible for LGV' => [
            'data' => [
                'licenceType' => ['id' => Licence::LICENCE_TYPE_STANDARD_INTERNATIONAL],
                'totAuthVehicles' => 10,
                'totAuthHgvVehicles' => 7,
        ...
        yield 'with changes to zero - eligible for LGV' => [
            'data' => [
                'licenceType' => ['id' => Licence::LICENCE_TYPE_STANDARD_INTERNATIONAL],
                'totAuthVehicles' => 20,
        ...
        yield 'with changes from null to zero - eligible for LGV' => [
            'data' => [
                'licenceType' => ['id' => Licence::LICENCE_TYPE_STANDARD_INTERNATIONAL],
                'totAuthVehicles' => 20,
                'totAuthHgvVehicles' => 15,
