...
/**
 * LetterAppendix Abstract Entity
 *
 * Auto-Generated
 *
...
abstract class AbstractLetterAppendix implements BundleSerializableInterface, JsonSerializable
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Dvsa\Olcs\Api\Entity\Letter\LetterAppendixVersion", fetch="EAGER", cascade={"persist"})
     ...
     *
     * @param \Dvsa\Olcs\Api\Entity\Letter\LetterAppendixVersion $currentVersion entity being set as the value
     *
     * @return self
     */
