...
/**
 * LetterAppendixVersion Abstract Entity
 *
 * Auto-Generated
 *
...
abstract class AbstractLetterAppendixVersion implements BundleSerializableInterface, JsonSerializable
{
     ...
     *
     * @ORM\ManyToOne(
     *     targetEntity="Dvsa\Olcs\Api\Entity\Letter\LetterAppendix",
     *     fetch="LAZY",
     *     inversedBy="versions"
     * )
     ...
     *
     * @param \Dvsa\Olcs\Api\Entity\Letter\LetterAppendix $letterAppendix entity being set as the value
     *
     * @return self
     */
