...
abstract class AbstractLetterType implements BundleSerializableInterface, JsonSerializable
{
     ...
     *
     * @param \Dvsa\Olcs\Api\Entity\Letter\LetterTestData $letterTestData entity being set as the value
     *
     * @return self
     */
     ...
     *
     * @param \Dvsa\Olcs\Api\Entity\Letter\MasterTemplate $masterTemplate entity being set as the value
     *
     * @return self
     */
