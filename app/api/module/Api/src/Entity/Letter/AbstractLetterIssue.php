...
/**
 * AbstractLetterIssue Abstract Entity
 *
 * Auto-Generated
 ...
 *    indexes={
 *        @ORM\Index(name="fk_letter_issue_current_version_id", columns={"current_version_id"}),
 ...
 *        @ORM\Index(name="uk_letter_issue_key", columns={"issue_key"})
 *    },
 *    uniqueConstraints={
...
abstract class AbstractLetterIssue implements BundleSerializableInterface, JsonSerializable
{
     ...
     *
     * @param \Dvsa\Olcs\Api\Entity\Letter\LetterIssueVersion $currentVersion new value being set
     *
     * @return LetterIssue
     */
