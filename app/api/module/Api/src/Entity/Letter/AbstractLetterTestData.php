...
/**
 * AbstractLetterTestData Abstract Entity
 *
 * Auto-Generated
...
abstract class AbstractLetterTestData implements BundleSerializableInterface, JsonSerializable
{
    ...
    /**
     * Descriptive name for the test dataset
     *
     * @var string
     *
    ...
    /**
     * JSON test data for placeholders
     *
     * @var array
     *
     * @ORM\Column(type="json", name="json", nullable=false)
     */
    protected $json = [];
