...
/**
 * AbstractPiSlaException Abstract Entity
 *
 * Auto-Generated
...
abstract class AbstractPiSlaException implements BundleSerializableInterface, JsonSerializable
{
     ...
     * SlaException
     *
     * @var \Dvsa\Olcs\Api\Entity\SlaException
     *
     * @ORM\ManyToOne(targetEntity="Dvsa\Olcs\Api\Entity\SlaException", fetch="LAZY")
     ...
     *
     * @param \Dvsa\Olcs\Api\Entity\SlaException $slaException new value being set
     *
     * @return PiSlaException
     */
     ...
     *
     * @return \Dvsa\Olcs\Api\Entity\SlaException     */
