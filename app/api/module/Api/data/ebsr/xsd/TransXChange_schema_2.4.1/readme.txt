Release 2.4.1 TransXChange  
(c) 2026 CROWN COPYRIGHT



2.5.2 is a minor update to TransXChange includes a two enhancement one to improve support for semi-flexible services and one registration references,
						as well as an update to the list of local transport authorities which is used to identify authorities with whom a registration is consulted with
						and where there is financial support being provided.
							- Functional
								-	PTIC-101 Enhanced Partnership Registration Numbers: 
										Update the document tag in TransXChange TXC_registration-v2-4-a to reflect that the number of characters is increased from 4 to 8.
								-	PTIC-102 Stop Activity Additional activities required
										Added enumerated values to Activity to reflect requirements for semi-flexible services,
								-	PTIC-106 Update of Enumerated list of Transport Authorities
										Since 2010 there have been a changes to transport authorities and the lack of the updated authorities in TransXChange
										this was becoming an issue for operators and OTC.


2023-07-19 Update for flexible bus service and enhanced partnership registrations
2.4.a is an upgrade that superceeds 2.4 for use in the bus open data service.

	Within TXC_journey_support the allowed Activity enumerations have been expanded to support use by flexible services
	Within TXC_registration the documentation for RegistrationNumber has bene updated to reflect that the number of characters is increased from 4 to 8.
...
Changes 
2026-03-06 v2.5.2 update to Authority list and flexible service enhancements
2010-12-30 V2.4
