...
return [
    ...
    'service_manager' => [
        ...
        'factories' => [
            ...
            \Dvsa\Olcs\Api\Service\EditorJs\LongTextConverterService::class => \Laminas\ServiceManager\Factory\InvokableFactory::class,
            \Dvsa\Olcs\Api\Service\LongText\LongTextTranslator::class => \Dvsa\Olcs\Api\Service\LongText\LongTextTranslatorFactory::class,
    ...
    \Dvsa\Olcs\Api\Domain\RepositoryServiceManagerFactory::CONFIG_KEY => [
        'factories' => [
            ...
            'LongText' => RepositoryFactory::class,
