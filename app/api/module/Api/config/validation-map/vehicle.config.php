...
return [
    ...
    CommandHandler\Application\UpdateVehicleNinePassengers::class => CanAccessApplicationWithId::class,
    CommandHandler\Application\UpdateVehicleOperatingSmall::class => CanAccessApplicationWithId::class,
    CommandHandler\Application\UpdateWrittenExplanation::class  => CanAccessApplicationWithId::class,
    CommandHandler\Application\UpdateNoveltyVehicles::class     => CanAccessApplicationWithId::class,
    CommandHandler\Application\UpdateSmallVehicleConditionsAndUndertaking::class => CanAccessApplicationWithId::class,
    CommandHandler\Application\UpdateSmallVehicleEvidence::class => CanAccessApplicationWithId::class,
    CommandHandler\Application\UpdateMainOccupationEvidence::class => CanAccessApplicationWithId::class,
    CommandHandler\Application\UpdateMainOccupationUndertakings::class => CanAccessApplicationWithId::class,
