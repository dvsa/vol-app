...
return [
    ...
    AppCompCommandHandler\UpdatePsvOperateNoveltyStatus::class                        => IsSideEffect::class,
    AppCompCommandHandler\UpdatePsvSmallPartWrittenStatus::class                      => IsSideEffect::class,
