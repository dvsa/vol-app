...
return [
    ...
    CommandHandler\Application\UpdateKnowledgeExperience::class => CanAccessApplicationWithId::class,
    ...
    QueryHandler\Application\KnowledgeExperience::class => CanAccessApplicationWithId::class,
