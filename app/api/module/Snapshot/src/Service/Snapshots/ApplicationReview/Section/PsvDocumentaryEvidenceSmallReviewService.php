...
class PsvDocumentaryEvidenceSmallReviewService extends AbstractReviewService
{
    ...
    public function getConfigFromData(array $data = []): array
    {
        $queryData = [
            ...
            'subCategory' => SubCategory::DOC_SUB_CATEGORY_SMALL_PSV_EVIDENCE_DIGITAL,
        ];
    ...
    {
        if ($data['smallVehicleEvidenceUploaded'] === Application::FINANCIAL_EVIDENCE_UPLOAD_LATER) {
