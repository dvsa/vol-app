OLCS.ready(function() {
   ...
   * 4) Almost entirely duped by irfo-partners.js, bus-servicenumbers.js
   */

    var targetFieldset = $('fieldset[data-group="fields[tradingNames]"]');
    ...
    var addAnother = function () {
        var html = ('' +
            '<div class="field">' +
            '<input name="fields[tradingNames][__id__][name]" class="" id="name" value="" type="text">' +
            '</div>' +
