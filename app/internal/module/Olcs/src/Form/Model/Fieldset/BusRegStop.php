...
class BusRegStop extends Base
{
    /**
     * @Form\Type("Radio")
     * @Form\Options({"label": "Use all bus stops", "value_options":{"N":"No", "Y":"Yes"}})
    ...
    /**
     * @Form\Type("Radio")
     * @Form\Options({"label": "Manoeuvres", "value_options":{"N":"No", "Y":"Yes"}})
     * @Form\Attributes({"value": "N"})
     */
    public $hasManoeuvre = 0;

    /**
     * @Form\Attributes({"id":"manoeuvreDetail","class":"extra-long","name":"manoeuvreDetail"})
     * @Form\Options({
    ...
    /**
     * @Form\Type("Radio")
     * @Form\Options({"label": "Need new bus stops", "value_options":{"N":"No", "Y":"Yes"}})
     * @Form\Attributes({"value": "N"})
     */
    public $needNewStop = 0;

    /**
     * @Form\Attributes({"id":"newStopDetail","class":"extra-long","name":"newStopDetail"})
     * @Form\Options({
    ...
    /**
     * @Form\Type("Radio")
     * @Form\Options({"label": "No fixed stopping points", "value_options":{"N":"No", "Y":"Yes"}})
     * @Form\Attributes({"value": "N"})
     */
    public $hasNotFixedStop = 0;

    /**
     * @Form\Attributes({"id":"notFixedStopDetail","class":"extra-long","name":"notFixedStopDetail"})
     * @Form\Options({
    ...
    /**
     * @Form\Attributes({"id":"subsidised","placeholder":"","class":"small"})
     * @Form\Options({
     ...
     */
    public $subsidised = 'bs_no';

    /**
     * @Form\Attributes({"id":"subsidyDetail","class":"extra-long","name":"subsidyDetail"})
     * @Form\Options({
