...
class AbstractLvaFormFactory implements AbstractFactoryInterface
{
    public const FORM_SERVICE_CLASS_ALIASES =  [
        ...
        'lva-application-vehicles_declarations_psv_operate_novelty' => VehiclesDeclarationsPsvOperateNovelty::class,
        ...
        'lva-variation-vehicles_declarations_psv_operate_novelty' => VehiclesDeclarationsPsvOperateNovelty::class,
    ...
    public function __invoke($container, $requestedName, array $options = null)
    {
        ...
        switch ($requestedName) {
            ...
            case self::FORM_SERVICE_CLASS_ALIASES['lva-variation-vehicles_declarations_psv_operate_novelty']:
                return new VehiclesDeclarationsPsvOperateNovelty($formHelper);
