...
/**
 * Irhp Permit Processing Note Controller
 */
class IrhpPermitProcessingNoteController extends AbstractInternalController implements
    ...
    ToggleAwareInterface
{
     ...
     */
    protected $navigationId = 'licence_irhp_permits_processing_notes';
    ...
    public function addAction()
    {
        ...
        // the param in routing is called 'permitid' and the field name in the transfer is 'ecmtPermitApplication'
        $this->defaultData['ecmtPermitApplication'] = $this->params()->fromRoute('permitid');
