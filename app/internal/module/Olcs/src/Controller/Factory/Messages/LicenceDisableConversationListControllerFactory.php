...
class LicenceDisableConversationListControllerFactory implements FactoryInterface
{
     ...
     * @return LicenceDisableConversationListController
     */
    public function createService(ServiceLocatorInterface $serviceLocator): LicenceDisableConversationListController
    {
        return $this->__invoke($serviceLocator, LicenceDisableConversationListController::class);
    }
}
