OLCS.ready(function() {
  ...
  /*
   * Add an on click handler to the save button to display a popup
  ...
  /*
   * Bind a keypress handler for when the user presses the "ENTER"
  ...
  $("input[type='radio']").click(function (e) {
    /*
     * Find the closest 'tr' tag (the row associated with the radio button)
     * and then find the dataset for the first child.
     */
    var data = e.target.closest('tr').children[0].firstElementChild.dataset;

    /*
     * Set the appropriate value for the dataset on the radio button
     * if the Permit Stock is able to be deleted
     */
