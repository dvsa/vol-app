 ...
 * @author Dan Eggleston <dan@stolenegg.com>
 */
final class ApplicationOverviewHelperServiceTest extends MockeryTestCase
{
    protected $sut;
    ...
    public static function getViewDataProvider(): \Iterator
    {
        yield 'new goods application' => [
        ...
        yield 'variation eligible for lgv' => [
            // application overview data
            [
                'id' => 69,
                'createdOn' => '2015-04-08',
        ...
        yield 'new psv special restricted application' => [
            // application overview data
            [
                'id' => 69,
                'createdOn' => '2015-04-08',
    ...
    public static function getInterimStatusProvider(): \Iterator
    {
        yield 'with interim' => [
            [
                'interimStatus' => [
    ...
    public static function getEntityChangeProvider(): \Iterator
    {
        yield 'with changes' => [
            [
                'id' => 69,
