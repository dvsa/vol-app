...
class WebDavJsonWebTokenGenerationServiceFactoryTest extends MockeryTestCase
{
    ...
    #[\PHPUnit\Framework\Attributes\Depends('invokeIsCallable')]
    #[\PHPUnit\Framework\Attributes\Test]
    public function invokeThrowsExceptionWhenInternalUrlPatternNotSet(): void
    {
        // Setup
        $sm = $this->createMock(ContainerInterface::class);
        ...
        // Expect
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionCode(0x40);
        $this->expectExceptionMessage('Config key internal_url_pattern: value must be set and not empty()');
