...
class TransportManagerTest extends MockeryTestCase
{
    ...
    public function testOnTransportManager(): void
    {
        $tmId = 1;
    ...
    public function testOnTransportManagerNotMerged(): void
    {
        $tmId = 1;
        $context = [
            'controller' => 'foo',
    ...
    public function testOnTransportManagerMerged(): void
    {
        $tmId = 1;
        $context = [
            'controller' => 'foo',
    ...
    private function setupGetTransportManager(TransportManager $sut, array $tmData = []): void
    {
