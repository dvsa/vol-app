 ...
 * })
 */
class CommunityLicenceDocument
{
    /**
     * @Form\Attributes({
    ...
    /**
     * @Form\ComposedObject("\Olcs\Form\Model\Form\Surrender\Fieldset\CommunityLicenceInPossession")
     */
    public $possessionContent = null;

    /**
     * @Form\ComposedObject("\Olcs\Form\Model\Form\Surrender\Fieldset\CommunityLicenceLost")
     */
    public $lostContent;

    /**
     * @Form\ComposedObject("\Olcs\Form\Model\Form\Surrender\Fieldset\CommunityLicenceStolen")
     */
