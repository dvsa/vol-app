...
class ReprintLicenceVehicleDiscConfirmationControllerFactory implements FactoryInterface
{
    /**
     ...
     * @deprecated
     */
    public function createService(ServiceLocatorInterface $serviceLocator): ReprintLicenceVehicleDiscConfirmationController
    {
        return $this->__invoke($serviceLocator, ReprintLicenceVehicleDiscConfirmationController::class);
    }
}
