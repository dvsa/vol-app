...
class TransferVehicleControllerFactory implements FactoryInterface
{
     ...
     * @deprecated
     */
    public function createService(ServiceLocatorInterface $serviceLocator): TransferVehicleController
    {
        return $this->__invoke($serviceLocator, TransferVehicleController::class);
    }
}
