        ...
        [
            'business_details' => [
                ...
                'options' => [
                    ...
                    'defaults' => [
                        'controller' => 'Lva' . ucfirst($lva) . '/BusinessDetails',
                        'action' => 'index',
                    ],
                ],
                'may_terminate' => true,
            ...
            'people' => [
                ...
                'options' => [
                    'route' => 'people[/]',
                    'defaults' => [
                        'controller' => 'Lva' . ucfirst($lva) . '/People',
                        'action' => 'index',
                    ],
                ],
                'may_terminate' => true,
            ...
            'operating_centres' => [
                ...
                'options' => [
                    ...
                    'defaults' => [
                        'controller' => 'Lva' . ucfirst($lva) . '/OperatingCentres',
                        'action' => 'index',
                    ],
                ],
                'may_terminate' => true,
            ...
            'vehicles' => [
                ...
                'options' => [
                    'route' => 'vehicles[/]',
                    'defaults' => [
                        'controller' => 'Lva' . ucfirst($lva) . '/Vehicles',
                        'action' => 'index',
                    ],
                ],
                'may_terminate' => true,
            ...
            'vehicles_psv' => [
                ...
                'options' => [
                    'route' => 'vehicles-psv[/]',
                    'defaults' => [
                        'controller' => 'Lva' . ucfirst($lva) . '/VehiclesPsv',
                        'action' => 'index',
                    ],
                ],
                'may_terminate' => true,
            ...
            'trailers' => [
                ...
                'options' => [
                    'route' => 'trailers[/]',
                    'defaults' => [
                        'controller' => 'Lva' . ucfirst($lva) . '/Trailers',
                        'action' => 'index',
                    ],
                ],
                'may_terminate' => true,
            ...
            'safety' => [
                ...
                'options' => [
                    'route' => 'safety[/]',
                    'defaults' => [
                        'controller' => 'Lva' . ucfirst($lva) . '/Safety',
                        'action' => 'index',
                    ],
                ],
                'may_terminate' => true,
            ...
            'licence_history' => [
                ...
                'options' => [
                    ...
                    'defaults' => [
                        'controller' => 'Lva' . ucfirst($lva) . '/LicenceHistory',
                        'action' => 'index',
                    ],
                ],
                'may_terminate' => true,
            ...
            'convictions_penalties' => [
                ...
                'options' => [
                    ...
                    'defaults' => [
                        'controller' => 'Lva' . ucfirst($lva) . '/ConvictionsPenalties',
                        'action' => 'index',
                    ],
                ],
                'may_terminate' => true,
