 ...
 */
final class AvailableCountriesTest extends TestCase
{
    ...
    public function testMapForFormOptions(array $data, array $expected, array $expectedValueOptions, array $expectedValue): void
    {
        ...
        $this->assertEquals($expected, $availableCountries->mapForFormOptions($data, $mockForm));
    }
    ...
    public static function dpTestMapForFormOptions(): \Iterator
    {
        ...
        yield 'list with data - nothing already selected' => [
            'data' => [
                AvailableCountriesDataSource::DATA_KEY => [
                    'countries' => [
                        [
        ...
        yield 'list with data - some already selected' => [
            'data' => [
                AvailableCountriesDataSource::DATA_KEY => [
                    'countries' => [
                        [
