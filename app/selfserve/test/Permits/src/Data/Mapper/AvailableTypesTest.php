 ...
 * AvailableTypesTest
 */
final class AvailableTypesTest extends TestCase
{
    ...
    public function testMapForFormOptions(array $data, array $expected, array $expectedValueOptions): void
    {
        ...
        $this->assertEquals($expected, $availableTypes->mapForFormOptions($data, $mockForm));
    }

    /**
     * @return \Iterator<(int | string), array<array<array<(array<(array<(array<string> | int | string)> | string)> | bool | int | string)>>>>
     *
     ...
     */
    public static function dpTestMapForFormOptions(): \Iterator
    {
        yield 'empty list' => [
            'data' => [
                'types' => [
