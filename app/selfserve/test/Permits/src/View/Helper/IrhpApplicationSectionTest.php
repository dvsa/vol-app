 ...
 */
final class IrhpApplicationSectionTest extends MockeryTestCase
{
    ...
    /**
     * @return \Iterator<(int | string), array<array<(array<(array<(array<(int | string)> | bool | string)> | string | true)> | int)>>>
     *
     ...
     */
    public static function dpTestInvokeWithData(): \Iterator
    {
        yield 'application path enabled - with q&a data' => [
            'application' => [
                'id' => 100,
                'irhpPermitType' => [
                    'isApplicationPathEnabled' => true,
