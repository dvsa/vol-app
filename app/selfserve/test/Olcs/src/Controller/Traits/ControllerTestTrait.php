...
trait ControllerTestTrait
{
    ...
    protected function shouldRemoveElements(m\MockInterface $form, array $elements): void
    {
    ...
    protected function createMockForm(string $formName): \Mockery\LegacyMockInterface
    {
     ...
     */
    protected function expectCommand(string $class, array $expectedDtoData, array $result, bool $ok = true, int $times = 1): void
    {
     ...
     * @param int $times call count
     */
    protected function expectQuery(string $class, array $expectedDtoData, array $result, bool $ok = true, int $times = 1): void
    {
