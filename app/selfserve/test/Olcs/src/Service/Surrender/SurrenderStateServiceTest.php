...
final class SurrenderStateServiceTest extends TestCase
{
    ...
    /**
     * @return \Iterator<(int | string), array<(array<array<(array<string> | string)>> | string)>>
     *
     ...
     */
    public static function fetchRouteDataProvider(): \Iterator
    {
        yield 'status_start' => [
            'surrender' => [
                'status' => [
        ...
        yield 'status_contacts_complete' => [
            'surrender' => [
                'status' => [
        ...
        yield 'status_lic_docs_complete_is_IL' => [
            'surrender' => [
                'status' => [
        ...
        yield 'status_lic_docs_complete_is_not_IL' => [
            'surrender' => [
                'status' => [
                    'id' => RefData::SURRENDER_STATUS_LIC_DOCS_COMPLETE
                ],
        ...
        yield 'status_comm_lic_docs_complete' => [
            'surrender' => [
                'status' => [
        ...
        yield 'status_details_confirmed' => [
            'surrender' => [
                'status' => [
    ...
    /**
     * @return \Iterator<(int | string), array<(array<(string | null)> | bool)>>
     *
     ...
     */
    public static function hasExpiredProvider(): \Iterator
    {
        yield 'has_created_and_is_expired' => [
            'surrender' => [
        ...
        yield 'has_created_modified_and_is_expired' => [
            'surrender' => [
                'createdOn' => '2019-01-31 14:13:09',
        ...
        yield 'has_created_and_is_not_expired' => [
            'surrender' => [
        ...
        yield 'has_created_modified_and_is_not_expired' => [
            'surrender' => [
                'createdOn' => date(DATE_ATOM, time()),
    ...
    /**
     * @return \Iterator<(int | string), array<(array<(array<(array<string> | int | string)> | int | string | null)> | string)>>
     *
     ...
     */
    public static function getStateProvider(): \Iterator
    {
        yield 'application_started' => [
            'surrender' => [
                'status' => [
                    'id' => RefData::SURRENDER_STATUS_START
                ],
        ...
        yield 'goods_disc_count_information_changed' => [
            'surrender' => [
                'status' => [
                    'id' => RefData::SURRENDER_STATUS_DISCS_COMPLETE
                ],
        ...
        yield 'psv_disc_count_information_changed' => [
            'surrender' => [
                'status' => [
                    'id' => RefData::SURRENDER_STATUS_DISCS_COMPLETE
                ],
        ...
        yield 'address_information_changed' => [
            'surrender' => [
                'status' => [
                    'id' => RefData::SURRENDER_STATUS_DISCS_COMPLETE
                ],
        ...
        yield 'address_information_not_modified' => [
            'surrender' => [
                'status' => [
                    'id' => RefData::SURRENDER_STATUS_DISCS_COMPLETE
                ],
        ...
        yield 'not_expired_and_not_changed' => [
            'surrender' => [
                'status' => [
                    'id' => RefData::SURRENDER_STATUS_DISCS_COMPLETE
                ],
