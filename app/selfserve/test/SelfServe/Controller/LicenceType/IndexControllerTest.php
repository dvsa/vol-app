...
class IndexControllerTest extends AbstractHttpControllerTestCase
{
    ...
    protected function setUpMockController($methods)
    {
        $this->controller = $this->getMock(
            '\SelfServe\Controller\LicenceType\IndexController', $methods
        );
    }
    ...
    public function testProcessOperatorLocation()
    {
        ...
        $mockRedirect->expects($this->once())
            ->method('toRoute')
            ->with(
                $this->equalTo('selfserve/licence-type'),
    ...
    {
        $this->setUpMockController(['getLicenceEntity']);
    ...
    public function testProcessLicenceType()
    {
        ...
        $mockRedirect->expects($this->once())
            ->method('toRoute')
            ->with(
                $this->equalTo('selfserve/licence-type-complete'),
                $this->equalTo(['applicationId' => $params['applicationId'], 'step' => $next_step])
            );
    ...
    {
        $this->setUpMockController(['params', 'redirect']);
        ...
        $mockRedirect->expects($this->once())
            ->method('toRoute')
            ->with(
                $this->equalTo('selfserve/business-type'),
